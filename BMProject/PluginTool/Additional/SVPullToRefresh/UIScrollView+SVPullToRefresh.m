...
- (void)scrollViewDidScroll:(CGPoint)contentOffset {
    if(self.state != SVPullToRefreshStateLoading) {
        ...
        if(!self.scrollView.isDragging && self.state == SVPullToRefreshStateTriggered && !self.exclusive) {
            ((UIScrollView *)self.superview).infiniteScrollingView.exclusive = YES;
            ...
            self.state = SVPullToRefreshStateStopped;
            ((UIScrollView *)self.superview).infiniteScrollingView.exclusive = NO;
        }
    ...
    switch (newState) {
        ...
        case SVPullToRefreshStateLoading:
            ...
            if(previousState == SVPullToRefreshStateTriggered && pullToRefreshActionHandler) {
                ...
                ((UIScrollView *)self.superview).infiniteScrollingView.enabled = YES;
            }
